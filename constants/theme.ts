...
export const appThemes = {
  ...
  dark: {
    ...
    text: {
      primary: "rgba(251, 247, 238, 0.95)",
      secondary: "rgba(241, 224, 164, 0.85)",
      tertiary: "rgba(201, 169, 97, 0.75)",
      muted: "rgba(175, 196, 184, 0.65)",
      subtle: "rgba(122, 138, 130, 0.70)",
      light: "rgba(175, 196, 184, 0.80)",
      onPrimary: "rgba(255, 249, 234, 0.98)",
    },
    accent: {
      sepia: "#5a4a35",
      night: "#000000",
    ...
    overlay: {
      dark: "rgba(15, 42, 33, 0.95)",
      darkLight: "rgba(15, 42, 33, 0.85)",
      light: "rgba(255, 249, 234, 0.12)",
      medium: "rgba(255, 249, 234, 0.08)",
    },
  },
} as const;
